...
import {Action} from "../../models/complaint/Action";

@Injectable({
  providedIn: 'root'
})
export class TrackingService {
  private apiUrl = 'http://localhost:9041/api/v1/api/v1/userTrack';
  ...
  trackEvent(eventType: string, details: any,userId:string) {
    ...
    this.sendTrackingData(userId, action).subscribe({
